...
class DenseNet(nn.Module):
    ...
    """
    def __init__(self, in_chs=3, growth_rate=32, block_config=(6, 12, 24, 16),
        ...
        self.features = nn.Sequential(OrderedDict([
            ('conv0', nn.Conv2d(in_chs, num_init_features, kernel_size=7, stride=2, padding=3, bias=False)),
        ...
        for i, num_layers in enumerate(block_config):
            ...
            if i != len(block_config) - 1:
                trans_stride = 1 if i == len(block_config) - 2 else 2
                print(i, trans_stride)
                trans = _Transition(
